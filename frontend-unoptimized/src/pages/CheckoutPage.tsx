...
const CheckoutPage: React.FC = () => {
  ...
  const handleCardNumberChange = (e: React.ChangeEvent<HTMLInputElement>, handleChange: (e: React.ChangeEvent<HTMLInputElement>) => void) => {
  ...
  const handleExpiryDateChange = (e: React.ChangeEvent<HTMLInputElement>, handleChange: (e: React.ChangeEvent<HTMLInputElement>) => void) => {
    handleChange(e);
  };
