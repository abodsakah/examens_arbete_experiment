...
const HomePage: React.FC = () => {
	...
	// Banner data - with WebP images
	const banners: Banner[] = [
		{
			id: 1,
			title: "Summer Sale",
			subtitle: "Up to 50% off on selected items",
			image: "/images/banner1.webp", // Using WebP format
		...
		},
		{
			...
			image: "/images/banner2.webp", // Using WebP format
		...
		},
		{
			...
			image: "/images/banner3.webp", // Using WebP format
	...
	const sliderSettings = {
		...
		autoplaySpeed: 5000,
		pauseOnHover: true,
		// Simplified responsive settings
		responsive: [
			{
				breakpoint: 768,
				settings: {
