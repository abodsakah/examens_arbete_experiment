...
const ProductDetailsPage = lazy(() => import(/* webpackChunkName: "product-details" */ "./pages/ProductDetailsPage"));
...
const OrderConfirmationPage = lazy(() => import(/* webpackChunkName: "order-confirmation" */ "./pages/OrderConfirmationPage"));
const OrderTrackingPage = lazy(() => import(/* webpackChunkName: "order-tracking" */ "./pages/OrderTrackingPage"));
